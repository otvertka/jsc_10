...
// // функция констуктор возвращает новый объект
// function User(name) {
...
//   };
// }
// const addressMr = createAddress('Гражданин');
// const addressMs = createAddress('Гражданинка');

// console.log(addressMr('Василий'));
// console.log(addressMs('Александра'));
...
//   };
// }
// const abc = urlGenerator('odessa');
// console.log(abc('cityrealty'));

// const comUrl = urlGenerator('com');
// console.log(comUrl('cavabanga'));
