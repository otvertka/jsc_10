...
const lufthansa = {
  ...
  book(flightnNum, name) {
    console.log(
      `${name} booked a seat on ${lufthansa.airline} flight ${lufthansa.iataCode}${flightnNum}`
    );
...
// Does NOT work  lufthansa функция bookaby была вызвана напрямую, а не как метод или свойство объекта.
